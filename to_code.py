...
forlders_guide = {'a_1': ' a/1', 'a_2': ' a/2', 'a_4': ' a/4', ' a_8': ' a/8', 'a_8d_8': ' a/8 d/8',
                  ...
                  'c1_8g1_8': ' c1/8 g1/8', 'cdef1_16': ' c1/16 d1/16 e1/16 f1/16',
                  ' cgde1_16': ' c1/16 g1/16 d1/16 e1/16',
...
def arrange_code_string(code_line):
    ...
    for c in code_line:
        ...
        if c == '2':
            code_line[i] = code_line[i].replace('2', '\meter <"4/')
            if code_line[i + 1] == '4':
                code_line[i + 1] = code_line[i + 1].replace('4', '2">')
            elif code_line[i + 1] == '2':
                code_line[i + 1] = code_line[i + 1].replace('2', '2">')
        if c == ' #' or c == ' ##' or c == ' &' or c == ' &&':
            symbol = c
